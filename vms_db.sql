...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2025 at 05:44 PM
...
INSERT INTO `tbl_employee` (`id`, `emp_code`, `emp_name`, `designation`, `division`, `contact_no`, `email`, `created_at`) VALUES
(1, '8219', 'Nisha Nandan', 'TO \'B\'', 'EMP892', '9685748596', 'nisha@gmail.com', '2025-03-03 15:48:33'),
(4, '8218', 'Vishal Sejwal', 'TO \'A\'', 'EMP892', '9687485987', 'vishal@gmail.com', '2025-03-03 16:27:49'),
(5, '8217', 'Ashutosh Sharma', 'SC \'E\'', 'EMP123', '97485759575', 'ashutosh@gmail.com', '2025-03-03 16:33:20'),
(6, '8215', 'Saneep Gupta', 'STA \'B\'', 'EMP123', '9875968575', 'sandeepgupta@gmail.com', '2025-03-03 16:36:28');
...
--
ALTER TABLE `tbl_employee`
  ADD CONSTRAINT `tbl_employee_ibfk_1` FOREIGN KEY (`division`) REFERENCES `tbl_department` (`hod`);
COMMIT;
